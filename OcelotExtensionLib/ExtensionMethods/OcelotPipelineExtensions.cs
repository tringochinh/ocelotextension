namespace OcelotExtensionLib.ExtensionMethods
{
    ...
    using OcelotExtensionLib.Middlewares;

    public static class OcelotPipelineExtensions
    {
        public static RequestDelegate BuildOcelotPipelineExtension(this IApplicationBuilder app,
            OcelotPipelineConfiguration pipelineConfiguration)
        {
            // this sets up the downstream context and gets the config
            //app.UseDownstreamContextMiddleware();
            app.UseMiddleware<ConfigurationMiddlewareExtension>();
